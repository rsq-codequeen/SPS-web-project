...
const Awards = () => {
  return (
    <div className="flex flex-row items-center justify-center relative">
      ...
      <div className="absolute flex flex-col gap-4 text-white text-justify w-11/12 sm:w-4/5 lg:w-3/5 p-4">
        <h1 className='font-semibold flex flex-row items-center text-lg md:text-xl lg:text-2xl'>

...
const Awards = () => {
  return (
   <div className="flex flex-row items-center justify-center relative">
               <img src={ButtonsBgImg} alt="background" className="w-full rotate-[180deg] h-80" />
               
               <div className="absolute flex flex-col gap-4 text-white text-justify w-3/5">
                <h1 className='font-semibold flex flex-row text-xl items-center'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-20">
...
We have an award-winning team that includes IBM-certified inventors and champions who have won multiple worldwide competitions.</h1>
                <p>

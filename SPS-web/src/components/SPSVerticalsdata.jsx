const SpsVerticalsdata = [
  ...
  },
  {
    ...
    title: 'Healthcare',
    desc: 'We support the healthcare industry and those who deliver health and human services, via telehealth or in person, to drive improvements in cost and quality, innovation and outcomes. We offer a unique combination of advanced technology solutions to help you drive impactful change, services to digitally transform organizations, and the ability to implement at scale, with the support of a trusted partner.',
    li: ['Telehealth & Remote Patient Monitoring', 'Multi-Clinic Consolidation', 'Compliance Requirements', 'Patient Experience', 'Health Systems Interoperability', 'Retail'],
  ...
  },
  {
    ...
    li: ['Supply Chain', 'Marketing/Merchandising', 'Personalization & Localization', 'Omni-channel Operations', 'Convenience Stores'],
